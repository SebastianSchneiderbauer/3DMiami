...
func _ready():
	...
	get_node("platform-00/entity_38_geometry").mesh.surface_get_material(0).set_texture_filter(0)
	#make barriers invisible
	get_node("barriers/entity_37_geometry").mesh.surface_get_material(0).set_transparency(1)
